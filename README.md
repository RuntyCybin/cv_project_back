...
Added `cvproject/Dockerfile` with a Maven build stage (Java 21) and slim runtime image.
Created `docker-compose.yml` to build from `cvproject`, expose `8080`, set default Spring profile, and auto-restart.
